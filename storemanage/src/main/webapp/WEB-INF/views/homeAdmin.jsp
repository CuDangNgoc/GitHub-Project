...
<div id = "menu_ngang">
    <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/admin/qlchinhanh.html" style="border-left:1px solid black;">Quản lý chi nhánh</a>   </li>
        <li><a href="${pageContext.request.contextPath}/admin/qlnhanvien.html">Quản lý nhân viên</a> </li>
		 ...
		 <div id="content_main" style="height:600px; ">
