		 ...
		 <table id="example" class="display" cellspacing="0" width="1018" 
					...
					<thead>
						<tr>
							...
							<th><a href="manager_themMaLoaiSP.jsp"> Thêm<img alt="" src="images/Add.png"></a> </th>
					...
					<tbody>
						...
						<tr>
							<td style="text-align: center;">ma loai san pham</td>
							<td style="text-align: center;">ten loai san pham</td>
							
							<td style="text-align: center;"><a href="manager_suaMaLoaiSP.jsp"><img alt="" src="images/Modify.png"></a> <a
